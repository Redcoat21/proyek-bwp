...
<template>
    <article class="flex flex-col border rounded-lg mx-auto max-w-1/2">
        <section class="flex justify-end p-3">
            <button v-on:click="$emit('close-button-clicked')" class="text-3xl text-coursera-blue mx-5">X</button>
        </section>
