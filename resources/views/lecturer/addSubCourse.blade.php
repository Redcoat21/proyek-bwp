...
<div class="px-96 rounded">
    <form action="" method="post" class="col-span-2 col-start-3 mt-2">
        ...
        <div class="col-span-2 col-start-3 mt-3">
            ...
            <div class="mt-1">
                <input id="" name="title" type="text" class="block w-full rounded-md border-0 py-1.5 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 text-sm leading-6" placeholder="SubCourse Name">
            </div>
        </div>
        <div class="col-span-2 col-start-3 mt-3">
