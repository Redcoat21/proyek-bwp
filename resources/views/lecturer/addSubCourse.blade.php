...
<div class="px-96">
    <form action="{{ route('auth.post') }}" method="post" class="col-span-2 col-start-3 mt-2">
        ...
        <div class="col-span-2 col-start-3 mt-3">
            ...
            <div class="mt-1">
                <input id="" name="" type="text" class="block w-full rounded-md border-0 py-1.5 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 text-sm leading-6" placeholder="Course Name" value="Networking" disabled readonly>
            </div>
        </div>
        <div class="col-span-2 col-start-3 mt-3">
            <label for="" class="block text-sm font-medium leading-6 text-gray-900">SUBCOURSE TITLE <span class="text-red-600">*</span></label>
            <div class="mt-1">
                <input id="" name="" type="text" class="block w-full rounded-md border-0 py-1.5 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 text-sm leading-6" placeholder="SubCourse Name">
            </div>
        </div>
        <div class="col-span-2 col-start-3 mt-3">
        ...
        <div class="col-span-2 col-start-3 mt-3">
            <label for="" class="block text-sm font-medium leading-6 text-gray-900">SUBCOURSE TEXT<span class="text-red-600">*</span></label>
            <div class="mt-1">
