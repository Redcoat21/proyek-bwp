    ...
    <form action="" method="post" class="col-span-2 col-start-3 mt-2">
        ...
        <div class="col-span-2 col-start-3 mt-3">
            ...
            <div class="mt-1 relative rounded-md shadow-sm">
                <input value="{{$subcourse->name}}" type="text" name="title" class="block rounded-lg w-full py-1.5 px-3 text-gray-900 placeholder:text-gray-400 border @error('email') border-red-500 @enderror focus:outline-none focus:ring-1 focus:ring-blue-300">
                <!-- Error Message -->
                @error('title')
        ...
        <div class="col-span-2 col-start-3 mt-3">
            ...
            <div class="mt-1 relative rounded-md shadow-sm">
                <textarea id="desc" name="desc" rows="4" cols="50" class="block rounded-lg w-full py-1.5 px-3 text-gray-900 placeholder:text-gray-400 border @error('desc') border-red-500 @enderror focus:outline-none focus:ring-1 focus:ring-blue-300" placeholder="Description">{{$subcourse->description}}</textarea>
            </div>
            @error('desc')
